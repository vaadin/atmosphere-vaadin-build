    ...
    public void process(File f, Document doc) throws Exception {
        ...
        for (int i = 0; i < nodes.getLength(); i++) {
            ...
            if (version != null) {
                ...
                if (!versionInPom.equals(versionBeingCompiled) && !versionInPom
                    .startsWith("${") && !versionInPom.contains("vaadin")) {
                    ...
                    System.out.println(
                        "Not replacing '" + groupId.getTextContent()
                            + "' with version '" + versionInPom + "'");
                    continue;
                } else {
                }
            }
